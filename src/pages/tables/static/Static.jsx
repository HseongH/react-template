        ...
        <Row>
            ...
            >
              ...
              <div className="clearfix">
                <div className="float-right">
                  ...
                  <UncontrolledButtonDropdown>
                    <DropdownToggle color="inverse" className="mr-xs" size="sm" caret>
                      Clear
                    </DropdownToggle>
                    <DropdownMenu>
          ...
          <Col lg={6} md={12} sm={12}>
            ...
            >
              ...
              <p>
                Each row is highlighted. You will never lost there. Just <code>.table-striped</code> it.
              </p>
                ...
                <Table className="table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Thornton</td>
                      <td>
                        <span className="text-secondary badge badge-gray">Away</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
        ...
        <Row>
          <Col lg={6} md={6} sm={12}>
            ...
            >
              ...
              <p>
                Each row is highlighted. You will never lost there. That&apos;s how all of us learned in school the
                table should look like. Just add
          ...
          <Col lg={6} md={6} sm={12}>
            ...
            >
              ...
              <p>
                Add any non-bordered .table within a widget for a seamless design. Awesome look for no cost. Just wrap
                the table with simple css class <code>.widget-table-overflow</code> inside of widget
              </p>
              <div className={`widget-table-overflow ${s.overFlow}`}>
