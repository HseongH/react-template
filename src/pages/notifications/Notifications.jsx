  ...
  addInfoNotification = () => {
    ...
    toast(
      <div>
        ...
        <Button onClick={() => this.launchNotification(id)} outline size="xs" className="width-100 mb-xs mr-xs mt-1">
          Cancel launch
        </Button>
      </div>,
      {
  ...
  addErrorNotification = () => {
    ...
    toast.error(
      <div>
        ...
        <Button onClick={() => this.retryNotification(id)} outline size="xs" className="width-100 mb-xs mr-xs mt-1">
          Retry
        </Button>
      </div>,
        ...
        <Widget title={<h6> Messenger </h6>} close collapse settings>
          <Row>
            ...
            <Col lg="4" xs="12">
              ...
              <p className="mb-3">
                <Button color="primary" id="show-info-message" onClick={this.addInfoNotification}>
                  Info Message
                </Button>
              </p>
              <p className="mb-3">
              ...
              <p>
                <Button color="success" id="show-success-message" onClick={this.addSuccessNotification}>
                  Success Message
                </Button>
              </p>
            </Col>
